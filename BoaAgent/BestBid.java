...
public class BestBid extends OMStrategy {
     ...
     * exactly one as a negotiation sometimes lasts slightly longer.
     */
     ...
     * Constructor
     */
    public BestBid(NegotiationSession negoSession, OpponentModel om) {
        this.init(negoSession, om, new HashMap<>() );
    }
     ...
     * bids.
     *
     * @param allBids  The list of the bids considered for offering.
     *
